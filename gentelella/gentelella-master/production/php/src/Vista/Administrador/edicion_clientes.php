                  ...
                  <div class="x_content">
                    ...
                    <form action="Actualizar.php" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post">
                      ...
                      <div class="form-group">
                        ...
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="local_intro">Id Clientes <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="number" id="idCliente" name="idCliente" required="required" class="form-control col-md-7 col-xs-12" readonly value="<?php echo intval($getid);?>"/>
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="nom_cliente" name="nom_cliente" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $getnombre ?>">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="number" id="din_conduc" name="din_conduc" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo intval($getdincond);?>">
                        </div>
                      </div>
                      <!-- aqui termina el registro del usuario-->
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="number" id="din_client" name="din_client" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo intval($getdincli);?>">
                        </div>
                      </div>
                        <!-- aqui termina el registro del usuario-->
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          <input  class="btn btn-success" type="submit" name="upd_cliente" id="upd_cliente" value="Editar Cliente">
                        </div>
                      </div>
