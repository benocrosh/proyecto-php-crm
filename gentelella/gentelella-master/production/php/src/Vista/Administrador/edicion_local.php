                  ...
                  <div class="x_content">
                    ...
                    <form action="Actualizar.php" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post">
                      ...
                      <div class="form-group">
                        ...
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="local_intro">Id Local <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="idlocal" name="idlocal" required="required" class="form-control col-md-7 col-xs-12" readonly value="<?php echo $getid ?>">
                        </div>
                      </div>
                      <div class="form-group">
                        <!-- Aqui se puso el ingreso de la dirección-->
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="nom_local" name="nom_local" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $getlocal ?>">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          <input  class="btn btn-success" type="submit" name="upd_local" id="upd_local" value="Editar Local">
                        </div>
                      </div>
