                  ...
                  <div class="x_content">
                    ...
                    <form action="Actualizar.php" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post">
                      ...
                      <div class="form-group">
                        ...
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="local_intro">Id Pasajero <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="idpasajero" name="idpasajero" required="required" class="form-control col-md-7 col-xs-12" readonly value="<?php echo $getid ?>">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="nom_pasajero" name="nom_pasajero" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $getnombre ?>">
                        </div>
                      </div>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="apepa_pasajero" name="apepa_pasajero" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $getapepa ?>">
                        </div>
                      </div>
                        <!-- aqui termina el registro del usuario-->
                        <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="apema_pasajero" name="apema_pasajero" class="form-control col-md-7 col-xs-12" value="<?php echo $getapema ?>">
                        </div>
                      </div>
                        <!-- aqui termina el registro del usuario-->
                        <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="telefono_registro" name="telefono_registro" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $gettel ?>">
                        </div>
                      </div>
                        <!-- aqui termina el registro del usuario-->
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          <input  class="btn btn-success" type="submit" name="upd_pasajero" id="upd_pasajero" value="Editar Pasajero">
                        </div>
                      </div>
