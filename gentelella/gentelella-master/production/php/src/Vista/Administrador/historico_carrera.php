                  ...
                  <div class="x_content" id="Edit" name="Edit">
                            <div class="row">
                               <div class="col-md-12 col-sm-5">
                                 <a href="Carreras.php"><button type="button" class="btn btn-success btn-sm pull-right" id="historic" name="historic">Volver a Carreras</button></a>
                               </div>
                             </div>
                            <div class="col-md-12 col-sm-12 col-xs-12" style="overflow-x: auto">
                              <table id="datatable" class="table table-striped table-bordered">
                                <thead>
                                    <tr>
                                    <th><a href="Historico.php?pag=<?php echo $inicio?>&col=id&pos=<?php echo $positionchange;?>#Edit">Id <i class="fa <?php echo $favicon;?>"></i></a></th>
