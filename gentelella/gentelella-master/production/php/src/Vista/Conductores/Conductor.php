                              ...
                              <table id="datatable" class="table table-striped table-bordered">
                                <thead>
                                  <tr>
                                    ...
                                    <th><a href="index.php?pag=<?php echo $inicio?>&col=kil&pos=<?php echo $positionchange;?>#Edit">Kilometros Recorridos <i class="fa <?php echo $favicon;?>"></i></a></th>
                                    <th><a href="index.php?pag=<?php echo $inicio?>&col=pas&pos=<?php echo $positionchange;?>#Edit">Cantidad Pasajeros <i class="fa <?php echo $favicon;?>"></i></a></th>
                                    <th><a href="index.php?pag=<?php echo $inicio?>&col=peaj&pos=<?php echo $positionchange;?>#Edit">Peajes <i class="fa <?php echo $favicon;?>"></i></a></th>
                                    ...
                                    <th><a href="index.php?pag=<?php echo $inicio?>&col=clie&pos=<?php echo $positionchange;?>#Edit">Cliente <i class="fa <?php echo $favicon;?>"></i></a></th>
                                  </tr>
                                </thead>
