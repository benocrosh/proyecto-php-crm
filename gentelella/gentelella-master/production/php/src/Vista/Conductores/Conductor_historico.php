        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              ...
              <a href="conductor.php" class="site_title"><i class="fa fa-paw"></i> <span>Conductor</span></a>
            </div>
          ...
          <div class="nav_menu">
            <nav>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false"> <?php echo $nomcond; ?>  
                              ...
                              <table id="datatable" class="table table-striped table-bordered">
                                <thead>
                                  <tr>
                                    ...
                                    <th><a href="Historico.php?pag=<?php echo $inicio?>&col=kil&pos=<?php echo $positionchange;?>#Edit">Kilometros Recorridos <i class="fa <?php echo $favicon;?>"></i></a></th>
                                    <th><a href="Historico.php?pag=<?php echo $inicio?>&col=pas&pos=<?php echo $positionchange;?>#Edit">Cantidad Pasajeros <i class="fa <?php echo $favicon;?>"></i></a></th>
                                    <th><a href="Historico.php?pag=<?php echo $inicio?>&col=peaj&pos=<?php echo $positionchange;?>#Edit">Peajes <i class="fa <?php echo $favicon;?>"></i></a></th>
                                    ...
                                    <th><a href="Historico.php?pag=<?php echo $inicio?>&col=clie&pos=<?php echo $positionchange;?>#Edit">Cliente <i class="fa <?php echo $favicon;?>"></i></a></th>
                                  </tr>
                                </thead>
                                ...
                                <tbody>
                                  <?php foreach($matrizcarreras as $datos):
                                      if(isset($datos["Conductor_idConductor"]) && isset($datos["Cliente_idCliente"])){
                                        $varcli=$datos["Cliente_idCliente"];
                                        $date= new DateTime($datos["Fecha"]);
                                        $idxnomclie=$union->union_idxnom_cliente($varcli);
