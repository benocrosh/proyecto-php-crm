		...
		public function delete_usuario(){
			//Verificador que efectivamente tiene algun valor no nulo los ingresos efectuados
				if(isset($this->Id)){
					...
					if($this->Id != 0){
						$update="UPDATE usuarios SET Estado= :estado Where idUsuarios= :id";
						...
						echo "<script>setTimeout(\"location.href = 'http://localhost/php/gentelella-master/production/php/administrador/Usuarios.php';\",1500);</script>";	
					}
