<?php
      ...
      if(!isset($_SESSION["admin"])){
        ...
        $matrizcarreras=$carreraspaginacion->get_carreras_historico($inicio, $tamano, $ordenrecibido);
        //get_carreras_paginacion($inicio, $cant, $ordenrecibido);
        ...
        require_once("../src/Vista/Administrador/historico_carrera.php");
