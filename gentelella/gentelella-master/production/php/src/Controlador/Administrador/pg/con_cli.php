<?php
      ...
      if(!isset($_SESSION["admin"])){
        ...
        $clientespaginacion=new mostrar_clientes();

        $filas=$clientes->get_clientes();
        $cant=count($filas);
        ...
        $ordenrecibido=$orders->render_get_clientes();


        $matrizusuarios=$usuarios->get_usuarios($privilegio);
        $matrizclientes=$clientespaginacion->get_clientes_paginacion($inicio, $cant, $ordenrecibido);
        ...
        require_once("../src/Vista/Administrador/Registro_Clientes.php");
      }
