<?php
	session_start();
      if(!isset($_SESSION["admin"])){
        ...
        $usuariospaginacion=new mostrar_usuarios();
        
        $filas=$usuarios->get_usuarios_estado();
        $cant=count($filas);
        ...
        $ordenrecibido=$orders->render_get_usuarios();
        
        $matrizusuarios=$usuariospaginacion->get_usuarios_estado_paginacion($inicio, $cant, $ordenrecibido);
        ...
        $displexc=$manexc->manejoexc();
		    ...
		    require_once("../src/Vista/Administrador/Registro_Usuarios.php");
      }
