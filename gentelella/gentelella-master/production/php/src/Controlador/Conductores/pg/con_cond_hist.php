<?php
      ...
      if(!isset($_SESSION["driver"])){
        ...
        $matrizcarreras=$carreraspaginacion->get_carreras_paginacion_conductor_historico($inicio, $idusu, $ordenrecibido, $tamano);
        ...
        $pag=$unionpagar->union_pagar_cond_face($cliente, $idcond);
      	...
      	require_once("../src/Vista/Conductores/Conductor_historico.php");
      }
